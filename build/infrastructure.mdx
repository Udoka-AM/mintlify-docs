...
description: "Agent Circle runs on Railway or Fly.io managed hosting with Cloudflare in front, keeping infrastructure costs low and allowing most budget to go toward engineering and developer revenue share."
---
...
The backend and database run on [Railway](https://railway.app/) or [Fly.io] — both are mainstream managed platforms that handle provisioning, scaling, and deployment without requiring DevOps specialization.
