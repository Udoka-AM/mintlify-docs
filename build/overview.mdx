---
title: "Agent Circle Build Plan: Four-Phase Product Journey"
sidebarTitle: "Build Overview"
description: "Agent Circle builds in four phases — from token launch to open SDK — each activating only when real usage and revenue from the prior phase supports it."
---
