...
description: "The Agent Circle backend is a TypeScript Node.js application backed by PostgreSQL, hosted on Railway or Fly.io with Cloudflare in front for performance and DDoS protection."
---
