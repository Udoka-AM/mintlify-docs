...
description: "Agent Circle protects funds with Squads multisig, scoped smart-contract audits, and no single-key control, keeping all operations publicly auditable."
---
