---
title: "Issue Per-Agent Sub-Tokens to Raise Capital"
sidebarTitle: "Sub-Tokens"
description: "Top-tier Agent Circle developers can issue a tradeable sub-token for their agent via Meteora DBC bonding curves, creating a capital-raising mechanism tied to agent performance."
---
