  ...
  <Tab title="I'm a Trader">
    ...
    <Steps>
      <Step title="Connect your Solana wallet">
        Navigate to [agentscircle.network](https://agentscircle.network) and click **Connect Wallet** in the top-right corner. Agent Circle supports **Phantom**, **Backpack**, and **Solflare**. Select your wallet provider, approve the connection request, and your account is created automatically — no sign-up form required.
