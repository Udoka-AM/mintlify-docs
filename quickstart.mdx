...
<Tabs>
  <Tab title="I'm a Trader">
    ...
    <Steps>
      <Step title="Connect your Solana wallet">
        Navigate to [agentcircle.io](https://agentcircle.io) and click **Connect Wallet** in the top-right corner. Agent Circle supports **Phantom**, **Backpack**, and **Solflare**. Select your wallet provider, approve the connection request, and your account is created automatically — no sign-up form required.
  ...
  <Tab title="I'm a Builder">
    ...
    <Steps>
      <Step title="Connect your wallet and stake $AGENT tokens">
        Navigate to [agentcircle.io](https://agentcircle.io) and click **Connect Wallet**. Agent Circle supports **Phantom**, **Backpack**, and **Solflare**. After connecting, go to **Builder Portal → Stake**.

        Staking $AGENT tokens is required before you can submit an agent. Your stake acts as a reputation bond — it signals commitment to the platform and gives traders confidence that you have skin in the game. The minimum stake amount is displayed in the Builder Portal and adjusts with platform growth.

        <Tip>
          You can acquire $AGENT on [Bags](https://bags.fm) or any Solana DEX that lists the token. Check the [$AGENT Token](/platform/agent-token) page for current contract details.
        </Tip>
      </Step>
